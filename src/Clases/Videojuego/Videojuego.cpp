...
ICollection * Videojuego::getJugadoresActivos(DtFechaHora * fecha,string nicknameUserLogg) {
    ...
    while (it->hasCurrent())
    {
        ...
        ICollection * nombresJugadoresEnEstaSuscr = suscr->getJugadoresActivos(fecha,nicknameUserLogg);
